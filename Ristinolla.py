...
class ristinolla:
    ...
    def pelaa(self):
        if self.pelilauta.anna_kierros() in (2,3,4,5,6,7,8,9): 
        ...
        while self.pelilauta.anna_pelaajamaara() not in (1,2):
            try: 
                self.pelilauta.aseta_pelaajamaara(int(input("Aloitetaan uusi peli. Syötä ihmispelaajien määrä (1/2) ")))
